...
function getInfoCards(p: Project): InfoCard[] {
  if (p.slug === "shinex") {
    return [
      { icon: ICON_MAP_PIN, label: "Location", value: "Astana, KZ" },
      ...
      >
        {cards.map((c) => (
          <RevealItem key={c.label}>
            <div className="group flex items-center gap-3 rounded-lg border border-white/10 bg-white/[0.035] p-4 transition-all duration-300 hover:-translate-y-1 hover:border-white/25 hover:bg-white/[0.05]">
              <div className="grid h-10 w-10 shrink-0 place-items-center rounded-lg border border-white/10 bg-white/[0.04] transition-transform duration-300 group-hover:scale-105">
                <Image
                  src={c.icon}
                  alt=""
                  width={24}
        ...
        {project.highlights.map((h, i) => (
          <RevealItem key={h}>
            <div className="card-glow group h-full rounded-lg border border-white/10 bg-white/[0.035] p-5 transition-all duration-300 hover:-translate-y-1 hover:border-white/25 hover:bg-white/[0.05]">
              <div className="mb-4 grid h-11 w-11 place-items-center rounded-lg border border-white/10 bg-white/[0.04] transition-transform duration-300 group-hover:scale-105">
                <Image
  ...
  return (
    <section className="mx-auto max-w-6xl px-5 py-12 sm:px-6 sm:py-16">
      <div className="grid gap-4 md:grid-cols-2">
        <Reveal>
          <div className="card-glow h-full rounded-lg border border-white/10 bg-white/[0.035] p-6 sm:p-7">
      ...
      <div className="grid gap-5 lg:grid-cols-12 lg:gap-6">
        <Reveal className="lg:col-span-8">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group relative block overflow-hidden rounded-lg border border-white/10 bg-white/[0.035] p-1.5 transition-all duration-500 hover:border-cyan-300/40 hover:bg-white/[0.05] sm:p-2"
          >
            <div className="overflow-hidden rounded-lg border border-white/10 bg-ink-950">
              <div className="flex items-center gap-2 border-b border-white/10 bg-white/[0.025] px-3 py-2.5 sm:px-4">
                <span className="h-2.5 w-2.5 rounded-full bg-rose-400/60" />
                <span className="h-2.5 w-2.5 rounded-full bg-amber-300/60" />
                <span className="h-2.5 w-2.5 rounded-full bg-emerald-400/60" />
                <div className="ml-3 hidden flex-1 items-center gap-2 rounded-md border border-white/10 bg-white/[0.035] px-3 py-1 sm:flex">
        ...
        <Reveal delay={0.1} className="lg:col-span-4">
          <div className="flex h-full flex-col gap-4 rounded-lg border border-white/10 bg-white/[0.035] p-6 sm:p-7">
            ...
            <div className="mt-2 grid grid-cols-2 gap-2 text-sm">
              <div className="rounded-lg border border-white/10 bg-white/[0.035] px-3 py-2.5">
                ...
                <div className="mt-0.5 font-semibold text-ink-50">Astana</div>
              </div>
              <div className="rounded-lg border border-white/10 bg-white/[0.035] px-3 py-2.5">
                <div className="text-[10px] uppercase tracking-[0.18em] text-ink-400">
                  Languages
                </div>
                <div className="mt-0.5 font-semibold text-ink-50">
                  RU / KK / EN
                </div>
              </div>
            </div>
            ...
            <div className="mt-auto flex flex-col gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex items-center justify-between gap-2 rounded-full bg-accent-cyan px-5 py-3 text-sm font-semibold text-ink-950 shadow-[0_10px_30px_-12px_rgba(45,212,191,0.7)] transition-all hover:-translate-y-0.5"
              >
                Open shinex.kz
              ...
              {project.phone && (
                <a
                  ...
                  className="group inline-flex items-center justify-between gap-2 rounded-full border border-white/15 bg-white/[0.05] px-5 py-3 text-sm font-semibold text-ink-50 backdrop-blur-md transition-all hover:border-white/30 hover:bg-white/[0.08]"
                >
      ...
      >
        {project.services.map((s, i) => (
          <RevealItem key={s.name}>
            <div
              className={`card-glow group relative h-full overflow-hidden rounded-lg border border-white/10 bg-white/[0.035] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300/40 hover:bg-white/[0.05] sm:p-7 ${
...
export function ShineXFeaturePanels() {
  return (
    <section className="mx-auto max-w-6xl px-5 py-12 sm:px-6 sm:py-16">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Reveal>
          <div className="relative overflow-hidden rounded-lg border border-white/10 bg-white/[0.035] p-5 transition-all duration-300 hover:border-white/25 hover:bg-white/[0.05] sm:p-6">
            <div className="mb-3 text-[11px] uppercase tracking-[0.22em] text-cyan-300/80">
              Booking flow
            </div>
            <h3 className="text-xl font-semibold text-ink-50">
              From service to date to Kaspi in under 60 seconds
            </h3>
            <div className="mt-4">
              <Image
            ...
            <div className="pointer-events-none absolute -bottom-3 -left-3 w-[90px] animate-float-slow sm:w-[110px]">
              <Image
                src="/assets/project/cleaning_bucket_bottom_left.webp"
                alt=""
                width={110}
                height={100}
              />
        ...
        <Reveal delay={0.1}>
          <div className="relative overflow-hidden rounded-lg border border-white/10 bg-white/[0.035] p-5 transition-all duration-300 hover:border-white/25 hover:bg-white/[0.05] sm:p-6">
            ...
            <div className="pointer-events-none absolute -bottom-2 -right-2 w-[70px] animate-float-med sm:w-[90px]">
              <Image
                src="/assets/project/bell_bottom_right.webp"
                alt=""
                width={90}
                height={80}
              />
